...
# Run as:  ipython mipdao/utils/varyParams.py  path_to_mipdao  name_of_graph_file  path_to_write_to  number_of_cpus
...
def printConfig(filename, k, cpus, nodes):
    ...
    fout.write("number of ants       : 24\n")
    fout.write("converge threshold   : 0.0001\n")
    fout.write("local optimization   : "+str(k)+"\n")
