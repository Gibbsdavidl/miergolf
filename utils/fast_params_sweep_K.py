...
# Run as:  ipython utils/fast_params_sweep_K.py  path_to_miergolf  name_of_graph_file  path_to_write_to  number_of_cpus
...
def printConfig(filename, k, cpus, nodes, outfile):
    ...
    fout.write("output file          : "+outfile+"\n")
    fout.close()
